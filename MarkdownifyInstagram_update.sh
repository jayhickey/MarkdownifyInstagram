...
if [ "$1" == "" ] ; then
	...
	echo "Example (for manual usage): ./MarkdownifyInstagram.sh /home/blog/secondcrack/www/media/instagram/ /home/blog/Dropbox/Blog/drafts/ /media/instagram/ http://jayhickey.com"
    echo "Example (or automated inotify usage): ./MarkdownifyInstagram.sh /home/blog/secondcrack/www/media/instagram/ /home/blog/Dropbox/Blog/drafts/ /media/instagram/ http://jayhickey.com /home/blog/Dropbox/Blog/scripts/MarkdownifyInstagram/"
    echo ""
    exit 1
fi
